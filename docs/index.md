...
- ВНИМАНИЕ КОСТЫЛЬ
 - Для того чтобы быстро перегенерить один пресет из интерфейса, добавлена возможность нажать на кнопку "скопировать ссылку в буфер" с зажатыми ctrl и alt с правами суперадмина. 
